...
- Landed via PR #6 (`v2-m1/epub-preference-override-compat` → `main`), verified by GitHub Actions CI (full frontend + Windows Rust promotion gate).
...
Current Branch / PR: `v2-m1/epub-preference-override-compat` → `main` via PR #6.
