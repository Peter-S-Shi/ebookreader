...
- Updated 2026-09-09: `FC-C01`, `FC-C02`, `FC-C04`, `FC-C06` closed via corrective-pass tickets 1-3; `FC-C05` partially closed (Appearance). 4 of the 8 confirmed (`FC-C01`-`FC-C08`) items are now fully closed.
- 2 items (`FC-A12`, `FC-A13`) were already genuinely closed — no ticket needed.
- 14 items still require corrective work before a second Feature Complete Candidate can be declared (see `FEATURE_COMPLETE_CORRECTIVE_TICKETS.md` for live status).
