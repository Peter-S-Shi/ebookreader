...
use commands::{
    ...
    create_reading_asset_command, delete_reading_asset_command, update_reading_asset_anchor_command,
    delete_collection_command, export_notebook_markdown_command, get_actual_reading_time_command, get_book_hours_command,
    get_alignment_package_command, get_alignment_package_by_id_command, list_alignment_packages_for_book_command, list_all_alignment_packages_command, get_alignment_statistics_command, delete_alignment_package_command,
    get_calendar_day_command, get_calendar_range_command,
    get_ocr_effective_text_command, get_ocr_job_command, get_ocr_status_command, get_reading_progress_command, get_setting_command,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_alignment_package_by_id_command,
            list_alignment_packages_for_book_command,
            list_all_alignment_packages_command,
            get_alignment_statistics_command,
            delete_alignment_package_command,
            ...
            delete_reading_asset_command,
            update_reading_asset_anchor_command,
